            ...
            <div>
                {
                    ...
                    <label className={styles.inputContainer}>
                        <input type={this.props.type} name={this.props.name} className={styles.inputField} onChange={(e) => this.model(e)}/>
                    ...
                    <label className={styles.inputContainer}>
                        <input value={this.props.val} type={this.props.type} name={this.props.name} className={styles.inputField} onChange={(e) => this.model(e)}/>
                        <span>{this.props.placeholder}</span>
                    </label>
                }
            </div>

...
const ClassCard = (props) => {
    ...
    return (
        <div className="hover:cursor-pointer flex flex-row py-3 pr-5" onClick={onPress}>
                <div style={{
                ...
                <div 
                    ...
                    className="bg-black w-32 h-44 flex flex-col justify-between py-5 pl-1">
                    ...
                    <div>
                        <p className="text-gray-400 text-xs font-sans rounded ">Total bookings</p>
